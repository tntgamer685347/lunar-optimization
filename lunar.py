...
def setup():
    ...
    sensitivity_settings = {"xy_sens": xy_sens, "targeting_sens": targeting_sens, "xy_scale": 10/xy_sens, "targeting_scale": 335/(targeting_sens * xy_sens), "targeting_scale_aiming": 955/(targeting_sens * xy_sens)}
