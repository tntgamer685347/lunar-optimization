...
def setup():
    ...
    sensitivity_settings = {"xy_sens": xy_sens, "targeting_sens": targeting_sens, "xy_scale": 10/xy_sens, "targeting_scale": 340/(targeting_sens * xy_sens), "targeting_scale_aiming": 960/(targeting_sens * xy_sens)}
